...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named TrendPoster
...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to TrendPoster.
...
- __Website__ refers to TrendPoster, accessible from [https://trendposter.app](https://trendposter.app)
...
- By email: yaseenhassan@mail.com